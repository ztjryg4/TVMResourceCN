...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        ...
        //resize_network(net, sized.w, sized.h);
            ...
            int m = plist->size;
            if(access("/home/ztj/tvm/darknet/data/multi/out",0)==-1)//路径
            {
              if (mkdir("/home/ztj/tvm/darknet/data/multi/out",0777))//路径
               {
        ...
        if(outfile){
            save_image(im, outfile);
             ...
             char b[2048];
            sprintf(b,"/home/ztj/tvm/darknet/data/multi/out/%s",GetFilename(path));//路径
